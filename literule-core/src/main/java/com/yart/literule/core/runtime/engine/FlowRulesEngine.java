...
import com.yart.literule.core.model.basic.RuleResult;
 ...
 */
public final class FlowRulesEngine extends AbstractRulesEngine {

    private static final Logger LOGGER = LoggerFactory.getLogger(FlowRulesEngine.class);

    /**
     * Create a new {@link FlowRulesEngine} with default parameters.
     */
    public FlowRulesEngine() {
        super();
    }

    /**
     * Create a new {@link FlowRulesEngine}.
     *
     * @param parameters of the engine
     */
    public FlowRulesEngine(final RulesEngineParameters parameters) {
        super(parameters);
    }
